...
<body>
	<div id="all">
		<div id="header">
			<h1 id="logo">
				<jdoc:include type="modules" name="logo_" />
...
-->
		...
		<div id="<?php echo $showRightColumn ? 'contentarea2' : 'contentarea'; ?>">
			...
			<div id="<?php echo $showRightColumn ? 'main2' : 'main'; ?>">
				...
				<jdoc:include type="modules" name="xemthem" />
		...
		<div id="footer">
			...
			<p>
<!--				<?php echo JText::_('Powered by');?> <a href="http://www.joomla.org/">Công ty TNHH Veritable!</a>
-->
			</p>
